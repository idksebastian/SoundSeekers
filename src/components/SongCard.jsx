      ...
      <div className="p-4 space-y-3">
        <div>
          ...
          <button onClick={goToArtist}
            className="text-gray-400 text-sm truncate hover:text-purple-600 transition flex items-center gap-1 mt-0.5 max-w-full">
            <svg className="w-3 h-3 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 19V6l12-3v13M9 19c0 1.105-1.343 2-3 2s-3-.895-3-2 1.343-2 3-2 3 .895 3 2zm12-3c0 1.105-1.343 2-3 2s-3-.895-3-2 1.343-2 3-2 3 .895 3 2zM9 10l12-3" />
            </svg>
            <span className="truncate">{displayArtist ?? 'Artista desconocido'}</span>
          </button>
        </div>
